...
void writeSolutionsToFile(/*const Vector<double>& U,*/ double l2Norm, std::string solutionTag){
  hid_t file_id, dataset_id, dataspace_id;
  herr_t      status;
  hsize_t dimens_1d;
  // std::cout << "writing solution for Coding Assignment 4 to file : " << solutionTag.c_str() << ".h5" << std::endl;
